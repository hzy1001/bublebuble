...
public class Player extends JLabel implements Moveable {
	...
	private void initBackgroundPlayerService() { 
		...
		// 바로 넘길수 있다.)
//		new Thread(new BackgroundPlayerService(mContext)).start();
		new Thread(new BackgroundPlayerService(this)).start();		//<== mContext(BubbleFrame)에는 아직 player가 객체가 생성되기 전이므로 this를 넘긴다.
